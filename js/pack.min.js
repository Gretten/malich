(function(window){var f=void 0,i=!0,k=null,m=!1;function n(a){return function(b){this[a]=b}}function q(a){return function(){return this[a]}}var r,s=this;
...
else if("function"==b&&"undefined"==typeof a.call)return"object";return b}function v(a){return"function"==u(a)}var w="amble_uid_"+Math.floor(2147483648*Math.random()).toString(36),aa=0;function ba(a,b){function c(){}c.prototype=b.prototype;a.S=b.prototype;a.prototype=new c};var ca=/^[a-zA-Z0-9\-_.!~*'()]*$/;function ea(a){a=""+a;return!ca.test(a)?encodeURIComponent(a):a};var fa=fa||{},ga=Array.prototype;function ha(a){return ga.concat.apply(ga,arguments)};function ia(){this.e={};this.q=[]}r=ia.prototype;r.a=0;r.k=function(a){return Object.prototype.hasOwnProperty.call(this.e,a)};r.set=function(a,b){Object.prototype.hasOwnProperty.call(this.e,a)||(this.a++,this.q.push(a));this.e[a]=b};r.get=function(a,b){return Object.prototype.hasOwnProperty.call(this.e,a)?this.e[a]:b};r.z=function(){return this.q.concat()};r.h=function(){for(var a=[],b=0;b<this.q.length;b++)a.push(this.e[this.q[b]]);return a};function y(a){this.b=new ia;this.ga=!!a}r=y.prototype;r.a=0;r.k=function(a){a=ja(this,a);return this.b.k(a)};r.z=function(){for(var a=this.b.h(),b=this.b.z(),c=[],d=0;d<b.length;d++)for(var g=a[d],e=0;e<g.length;e++)c.push(b[d]);return c};r.h=function(a){var b=[];if(a)this.k(a)&&(b=ha(b,this.b.get(ja(this,a))));else for(var a=this.b.h(),c=0;c<a.length;c++)b=ha(b,a[c]);return b};r.set=function(a,b){a=ja(this,a);this.k(a)&&(this.a-=this.b.get(a).length);this.b.set(a,[b]);this.a++;return this};
r.get=function(a,b){var c=a?this.h(a):[];return 0<c.length?c[0]:b};function ja(a,b){var c=""+b;a.ga&&(c=c.toLowerCase());return c}r.toString=function(){if(!this.a)return"";for(var a=[],b=this.b.z(),c=0;c<b.length;c++)for(var d=b[c],g=ea(d),d=this.h(d),e=0;e<d.length;e++){var h=g;""!==d[e]&&(h+="="+ea(d[e]));a.push(h)}return a.join("&")};var ka,la,z,A;function ma(){return s.navigator?s.navigator.userAgent:k}function B(){return s.navigator}A=z=la=ka=m;var C;if(C=ma()){var na=B();A=0==C.indexOf("Opera");ka=!A&&-1!=C.indexOf("MSIE");z=!A&&-1!=C.indexOf("WebKit");la=!A&&!z&&"Gecko"==na.product}var oa=A,D=ka,E=la,F=z,pa=B(),qa=-1!=(pa&&pa.platform||"").indexOf("Mac"),ra={};function sa(){return ra[9]||(ra[9]=D&&!!document.documentMode&&9<=document.documentMode)}var ta;
a:{var G="",H;if(oa&&s.opera)var ua=s.opera.version,G="function"==typeof ua?ua():ua;else if(E?H=/rv\:([^\);]+)(\)|;)/:D?H=/MSIE\s+([^\);]+)(\)|;)/:F&&(H=/WebKit\/(\S+)/),H)var va=H.exec(ma()),G=va?va[1]:"";if(D){var wa,xa=s.document;wa=xa?xa.documentMode:f;if(wa>parseFloat(G)){ta=""+wa;break a}}ta=G}var ya={};
function I(a){var b;if(!(b=ya[a])){b=0;for(var c=(""+ta).replace(/^[\s\xa0]+|[\s\xa0]+$/g,"").split("."),d=(""+a).replace(/^[\s\xa0]+|[\s\xa0]+$/g,"").split("."),g=Math.max(c.length,d.length),e=0;0==b&&e<g;e++){var h=c[e]||"",j=d[e]||"",l=RegExp("(\\d*)(\\D*)","g"),p=RegExp("(\\d*)(\\D*)","g");do{var t=l.exec(h)||["","",""],o=p.exec(j)||["","",""];if(0==t[0].length&&0==o[0].length)break;b=((0==t[1].length?0:parseInt(t[1],10))<(0==o[1].length?0:parseInt(o[1],10))?-1:(0==t[1].length?0:parseInt(t[1],
10))>(0==o[1].length?0:parseInt(o[1],10))?1:0)||((0==t[2].length)<(0==o[2].length)?-1:(0==t[2].length)>(0==o[2].length)?1:0)||(t[2]<o[2]?-1:t[2]>o[2]?1:0)}while(0==b)}b=ya[a]=0<=b}return b};var J=m;function K(a){a.match(/[\d]+/g).length=3}var L=B();
if(L.plugins&&L.plugins.length){var za=L.plugins["Shockwave Flash"];za&&(J=i,za.description&&K(za.description));L.plugins["Shockwave Flash 2.0"]&&(J=i)}else if(L.mimeTypes&&L.mimeTypes.length){var Aa=L.mimeTypes["application/x-shockwave-flash"];(J=!(!Aa||!Aa.enabledPlugin))&&K(Aa.enabledPlugin.description)}else try{var M=new ActiveXObject("ShockwaveFlash.ShockwaveFlash.7"),J=i;K(M.GetVariable("$version"))}catch(Ba){try{M=new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6"),J=i,M.ra="always",K(M.GetVariable("$version"))}catch(Ca){try{M=
new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),J=i,K(M.GetVariable("$version"))}catch(Da){}}};var Ea=["application/x-silverlight","application/x-silverlight-2","application/x-silverlight-2-b2","application/x-silverlight-2-b1"],N=B();
if(!N.plugins||!N.plugins.length)if(N.mimeTypes&&N.mimeTypes.length)for(var O=0;O<Ea.length;O++){var Fa=N.mimeTypes[Ea[O]];if(Fa&&Fa.enabledPlugin)break}else{var Ga=[0,0,0,0];try{for(var Ha=new ActiveXObject("AgControl.AgControl"),O=0;O<Ga.length;O++){for(var Ia=0,Ja=1048575,Ka=0;Ia<Ja;){var La=Ga[O]=Ia+(Ja-Ia>>1);Ha.IsVersionSupported(Ga.join("."))?(Ka=La,Ia=La+1):Ja=La}Ga[O]=Ka}}catch(Ma){}};function Na(){return+new Date+Math.round(2147483647*Math.random())}var Oa="https:"==document.location.protocol?"https:":"http:";function Pa(a,b,c,d){var g=[];a&&g.push(a,"//");b&&g.push(b);c&&g.push(c);d&&g.push("?",d);return g.join("")}function Qa(a){return a.join(".")}function Ra(a){a!==f&&this.C(a);this.U={}}r=Ra.prototype;r.A="rcounter.rambler.ru/count";r.u="rcounter.rambler.ru/click";r.g=k;r.i=k;r.j=k;r.d=0;r.C=n("g");r.G=q("g");r.R=n("i");r.H=q("i");r.ja=n("A");r.ba=q("A");r.la=n("u");
r.da=q("u");r.ia=n("j");r.aa=q("j");r.ma=n("d");r.ea=q("d");r.oa=function(a,b){this.U[a]=b};r.J=function(a,b){var c=this.U[a];return c!==f?c:b};function Sa(a,b){for(var c=b.split("."),d=0,g=c.length;d<g;d++)c[d]&&"$"==c[d].charAt(0)&&(c[d]=a.J(c[d].substring(1),"unknown_variable"));return Qa(c)}
function Ta(a,b,c){var b=b.split("-"),d=[],g=[];a.j&&d.push(a.j);c&&d.push(c);if(d=Qa(d)){Sa(a,d);for(var c=0,e=b.length;c<e;c++)g.push(Qa([d,Sa(a,b[c])]))}else{c=0;for(e=b.length;c<e;c++)g.push(Sa(a,b[c]))}return g.join("-")}
r.pa=function(a,b,c,d,g){var e;b!==f&&("string"==typeof b?e=b:(v(b.complete)&&(c=d=b.complete),b.timeout!==f&&(g=b.timeout)));b=new y;b.set("rn",Na());b.set("v","0.1");b.set("id",this.g);b.set("pid",this.i);b.set("path",Ta(this,a,e));a=Pa(Oa,this.A,"/"+Na()+"/",b.toString());e=d;d=new Image(1,1);g="number"==typeof g?g:this.d;b=k;e=Ua(d,e);0<g&&(b=window.setTimeout(e,g));c=Va(d,c,b);d.onerror=d.onabort=e;d.onload=c;d.src=a};
r.qa=function(a,b){var c=new y;c.set("v","0.1");c.set("id",this.g);c.set("pid",this.i);c.set("path",Ta(this,b));c.set("url",a);document.location.href=Pa("http:",this.u,k,c.toString())};r.link=function(a,b){if(!a.V){var c=new y;c.set("v","0.1");c.set("id",this.g);c.set("pid",this.i);c.set("path",Ta(this,b));c.set("url",a.href);a.V=a.href;a.href=Pa("http:",this.u,k,c.toString())}};function Va(a,b,c){return function(){window.clearTimeout(c||k);Wa(a);v(b)&&b()}}
function Ua(a,b){return function(){Wa(a);v(b)&&b()}}function Wa(a){a.onload=a.onerror=a.onabort=k;delete a}function P(){this.T={}}P.prototype.X=0;P.prototype.l=function(a,b){return this.T[a!==f?a:"~"+this.X++]=new Ra(b)};P.prototype.o=function(a){return this.l(f,a)};P.prototype.I=function(a){a=a||"";return this.T[a]||this.l(a,f)};function Xa(a){this.W=a||new P}
Xa.prototype.push=function(a){for(var b=arguments,c=0,d=0;d<b.length;d++)try{if(v(b[d]))setTimeout(b[d],0);else{var g="",e=b[d][0],h=e.lastIndexOf(".");0<h&&(g=e.substring(0,h),e=e.substring(h+1));var j=this.W.I(g);j[e].apply(j,b[d].slice(1))}}catch(l){c+=1}return c};var Q=Ra.prototype;Q.setAccountId=Q.C;Q.setAccount=Q.C;Q.getAccountId=Q.G;Q.getAccount=Q.G;Q.setProjectId=Q.R;Q.setProject=Q.R;Q.getProjectId=Q.H;Q.getProject=Q.H;Q.setGifPath=Q.ja;Q.getGifPath=Q.ba;Q.setRedirectURL=Q.la;Q.getRedirectURL=Q.da;Q.setBasePath=Q.ia;Q.getBasePath=Q.aa;Q.setRequestTimeout=Q.ma;Q.getRequestTimeout=Q.ea;Q.setVariable=Q.oa;Q.getVariable=Q.J;Q.track=Q.pa;Q.trackByRedirect=Q.qa;Q.link=Q.link;var R=P.prototype;R.createTracker=R.l;R.getTrackerByName=R.I;R.getTracker=R.o;
R.getRTracker=R.o;var S=s._tesla||{},Ya=S._ext||{},Za=S._cmd||[];if(!S||!v(S.l)){s._tesla=S=new P;S._ext=Ya;var $a=new Xa(S);"array"==u(Za)&&$a.push.apply($a,Za);S._cmd=$a}s.Rama=P;function ab(){}ab.prototype.F=m;ab.prototype.m=function(){this.F||(this.F=i,this.n())};ab.prototype.n=function(){this.Z&&bb.apply(k,this.Z)};function bb(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b],g=d,e=u(g);"array"==e||"object"==e&&"number"==typeof g.length?bb.apply(k,d):d&&"function"==typeof d.m&&d.m()}};function cb(a){cb[" "](a);return a}cb[" "]=function(){};var T={},U={},V={},W={};
function db(a,b,c,d,g){if(b)if("array"==u(b))for(var e=0;e<b.length;e++)db(a,b[e],c,d,g);else{var d=!!d,h=U;b in h||(h[b]={a:0,c:0});h=h[b];d in h||(h[d]={a:0,c:0},h.a++);var h=h[d],j=a[w]||(a[w]=++aa),l;h.c++;if(h[j]){l=h[j];for(e=0;e<l.length;e++)if(h=l[e],h.r==c&&h.L==g){if(h.f)break;return}}else l=h[j]=[],h.a++;e=eb();e.src=a;h=new fb;h.p(c,e,a,b,d,g);c=h.key;e.key=c;l.push(h);T[c]=h;V[j]||(V[j]=[]);V[j].push(h);a.addEventListener?(a==s||!a.Y)&&a.addEventListener(b,e,d):a.attachEvent(b in W?W[b]:
W[b]="on"+b,e)}else throw Error("Invalid event type");}function eb(){var a=gb?function(b){return hb.call(a.src,a.key,b)}:function(b){b=hb.call(a.src,a.key,b);if(!b)return b};return a}function ib(a,b,c,d){if(!d.s&&d.N){for(var g=0,e=0;g<d.length;g++)d[g].f?d[g].Q.src=k:(g!=e&&(d[e]=d[g]),e++);d.length=e;d.N=m;0==e&&(delete U[a][b][c],U[a][b].a--,0==U[a][b].a&&(delete U[a][b],U[a].a--),0==U[a].a&&delete U[a])}}
function jb(a,b,c,d,g){var e=1,b=b[w]||(b[w]=++aa);if(a[b]){a.c--;a=a[b];a.s?a.s++:a.s=1;try{for(var h=a.length,j=0;j<h;j++){var l=a[j];l&&!l.f&&(e&=kb(l,g)!==m)}}finally{a.s--,ib(c,d,b,a)}}return Boolean(e)}
function kb(a,b){var c=a.handleEvent(b);if(a.D){var d=a.key;if(T[d]){var g=T[d];if(!g.f){var e=g.src,h=g.type,j=g.Q,l=g.capture;e.removeEventListener?(e==s||!e.Y)&&e.removeEventListener(h,j,l):e.detachEvent&&e.detachEvent(h in W?W[h]:W[h]="on"+h,j);e=e[w]||(e[w]=++aa);j=U[h][l][e];if(V[e]){var p=V[e];fa.remove(p,g);0==p.length&&delete V[e]}g.f=i;j.N=i;ib(h,l,e,j);delete T[d]}}}return c}
function hb(a,b){if(!T[a])return i;var c=T[a],d=c.type,g=U;if(!(d in g))return i;var g=g[d],e,h;if(!gb){var j;if(!(j=b))a:{j=["window","event"];for(var l=s;e=j.shift();)if(l[e]!=k)l=l[e];else{j=k;break a}j=l}e=j;j=i in g;l=m in g;if(j){if(0>e.keyCode||e.returnValue!=f)return i;a:{var p=m;if(0==e.keyCode)try{e.keyCode=-1;break a}catch(t){p=i}if(p||e.returnValue==f)e.returnValue=i}}p=new X;p.p(e,this);e=i;try{if(j){for(var o=[],da=p.currentTarget;da;da=da.parentNode)o.push(da);h=g[i];h.c=h.a;for(var x=
o.length-1;!p.P&&0<=x&&h.c;x--)p.currentTarget=o[x],e&=jb(h,o[x],d,i,p);if(l){h=g[m];h.c=h.a;for(x=0;!p.P&&x<o.length&&h.c;x++)p.currentTarget=o[x],e&=jb(h,o[x],d,m,p)}}else e=kb(c,p)}finally{o&&(o.length=0),p.m()}return e}d=new X(b,this);try{e=kb(c,d)}finally{d.m()}return e};!D||sa();var gb=!D||sa(),lb=D&&!I("8");!F||I("528");E&&I("1.9b")||D&&I("8")||oa&&I("9.5")||F&&I("528");E&&!I("8")||D&&I("9");function Y(a,b){this.type=a;this.currentTarget=this.target=b}ba(Y,ab);Y.prototype.n=function(){delete this.type;delete this.target;delete this.currentTarget};Y.prototype.B=i;Y.prototype.preventDefault=function(){this.B=m};function X(a,b){a&&this.p(a,b)}ba(X,Y);r=X.prototype;r.target=k;r.relatedTarget=k;r.offsetX=0;r.clientX=0;r.clientY=0;r.screenX=0;r.screenY=0;r.button=0;r.keyCode=0;r.charCode=0;r.ctrlKey=m;r.altKey=m;r.shiftKey=m;r.metaKey=m;r.O=m;r.w=k;
r.p=function(a,b){var c=this.type=a.type;Y.call(this,c);this.target=a.target||a.srcElement;this.currentTarget=b;var d=a.relatedTarget;if(d){if(E){var g;a:{try{cb(d.nodeName);g=i;break a}catch(e){}g=m}g||(d=k)}}else"mouseover"==c?d=a.fromElement:"mouseout"==c&&(d=a.toElement);this.relatedTarget=d;this.offsetX=F||a.offsetX!==f?a.offsetX:a.layerX;this.offsetY=F||a.offsetY!==f?a.offsetY:a.layerY;this.clientX=a.clientX!==f?a.clientX:a.pageX;this.clientY=a.clientY!==f?a.clientY:a.pageY;this.screenX=a.screenX||
0;this.screenY=a.screenY||0;this.button=a.button;this.keyCode=a.keyCode||0;this.charCode=a.charCode||("keypress"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.O=qa?a.metaKey:a.ctrlKey;this.state=a.state;this.w=a;delete this.B;delete this.P};
r.preventDefault=function(){X.S.preventDefault.call(this);var a=this.w;if(a.preventDefault)a.preventDefault();else if(a.returnValue=m,lb)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};r.n=function(){X.S.n.call(this);this.relatedTarget=this.currentTarget=this.target=this.w=k};function fb(){}var mb=0;r=fb.prototype;r.key=0;r.f=m;r.D=m;r.p=function(a,b,c,d,g,e){if(v(a))this.M=i;else if(a&&a.handleEvent&&v(a.handleEvent))this.M=m;else throw Error("Invalid listener argument");this.r=a;this.Q=b;this.src=c;this.type=d;this.capture=!!g;this.L=e;this.D=m;this.key=++mb;this.f=m};r.handleEvent=function(a){return this.M?this.r.call(this.L||this.src,a):this.r.handleEvent.call(this.r,a)};function nb(a,b){var c=b||{};this.v=a;this.$=c.element||document.body;this.d=c.timeout||200;this.K=c.goalAttrName||"data-tesla-goal";this.ha=c.pathAttrName||"data-tesla-path";this.t=c.pathPrefix||"clickmap";var d=this;db(this.$,"click",function(a){ob(d,a)})}r=nb.prototype;r.setTimeout=n("d");r.fa=q("d");r.na=n("v");r.o=q("v");r.ka=n("t");r.ca=q("t");var pb={ua:"_SELF",ta:"_PARENT",va:"_TOP",sa:"_BLANK"};
function qb(){for(var a=document.getElementsByName("base"),b=0;b<a.length;b++)if(a[b].target)return a[b].target;return"_SELF"}function rb(a,b){for(var c=[],d;b;)(d=(b&&b.getAttribute?b.getAttribute(a.K):k)||(b&&b.getAttribute?b.getAttribute(a.ha):k))&&c.unshift(d),b=b.parentNode;return c.join(".")}function sb(a,b){for(var c;b;){if(c=b&&b.getAttribute?b.getAttribute(a.K):k)return b;b=b.parentNode}return k}function tb(a){var b=a.indexOf("#");return-1==b?a:a.substring(0,b)}
function ob(a,b){var c=sb(a,b.target);if(c){var d=rb(a,c),g=tb(document.URL),e=!(!c||!(1==c.nodeType&&"a"==c.tagName.toLowerCase())),h=k,j=k;e&&(h=c.href,j=tb(h));!b.B&&!b.O&&e&&g!=j&&"_BLANK"!=pb[(c.target||qb()).toUpperCase()]?(b.preventDefault(),c=function(){window.location.href=h},a.v.track(d,a.t,c,c,a.d)):a.v.track(d,a.t)}};var Z=nb.prototype;Z.setTimeout=Z.setTimeout;Z.getTimeout=Z.fa;Z.setTracker=Z.na;Z.getTracker=Z.o;Z.setPathPrefix=Z.ka;Z.getPathPrefix=Z.ca;var $=s._tesla||{};if(!$||!v($.createTracker))s._tesla=$;$._ext||($._ext={});$._ext.ClickMap=nb;s.tesla={ClickMap:nb};})(window);
